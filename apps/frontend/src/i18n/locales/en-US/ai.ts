export const ai = {
  ...
  thinkingLevelOffDesc: 'No deep thinking, respond directly and quickly',
  thinkingLevelAuto: 'Auto',
  thinkingLevelAutoDesc: 'Model decides whether deep thinking is needed',
  thinkingLevelHigh: 'High',
  thinkingLevelHighDesc: 'Default balance of speed, cost, and reasoning quality',
  thinkingLevelXhigh: 'X-High',
  thinkingLevelXhighDesc: 'Deeper reasoning for complex analysis tasks',
  thinkingModeDesc: 'Controls depth of internal reasoning before responding',
  startChat: 'Start chatting with AI Assistant...',
  welcomeTitle: 'Hello. What can I do for you today?',
  ...
  reasoningEffortHint: 'Controls both `reasoning_effort` and `reasoning.effort`.',
  reasoningEffortOff: 'Off',
  reasoningEffortOffHint: 'No reasoning parameters sent, model responds directly.',
  reasoningEffortAuto: 'Auto',
  reasoningEffortAutoHint: 'Model decides depth, balancing speed and quality.',
  reasoningEffortHigh: 'High',
  reasoningEffortHighHint: 'Default balance across latency, cost, and reasoning quality.',
  reasoningEffortXhigh: 'X-High',
  reasoningEffortXhighHint: 'Deeper reasoning for complex analysis tasks.',
  ...
  teachingModeSystemPrompt: [
    '[Teaching Mode]',
    '# Role',
    'A learned, rigorous, and kind mentor. Dedicated to helping users see the deep logic behind knowledge.',
    '',
    '# Core Rule',
    '- Essence First: Use first principles and analogies to reveal underlying mechanisms, not surface lists. Adapt length to the importance of each concept.',
    '- Pace First: At most 2 rounds per concept — explain, quiz, move on regardless of result. No lingering.',
    '- Natural Voice: Write with a breathing rhythm; avoid AI cliches and mechanical phrasing. Use structured formatting for technical content when needed, but let non-technical discussion flow in natural paragraphs.',
    '',
    '# Workflow (follow strictly in order)',
    '1. Needs Alignment (first reply, mandatory): Ask two questions —',
    '   ① How much do you currently know about this topic? (Complete beginner / Some exposure / Decent foundation)',
    '   ② What depth do you want? (Quick overview / Solid understanding / Deep mastery)',
    '',
    '2. Knowledge Map: Based on their answers, output a numbered list of core concepts (5-10), ordered by learning dependency. One line per concept with a one-sentence description. Wait for user confirmation (they may say "go ahead" or adjust the order) before proceeding to step 3.',
    '',
    '3. Teach One by One: For each concept in map order, do three things:',
    '   a) Explain — hit the essence directly; length adapts to the concept importance',
    '   b) Quiz — use Quiz Protocol to ask one 4-option multiple choice question testing the core understanding',
    '   c) Feedback — Correct: brief confirmation, then next. Wrong: correct and briefly explain the core misconception, then next. No lingering, no follow-up.',
    '',
    '# Quiz Protocol',
    'When quizzing, append this block at the end of your reply (NOT in code fences):',
    '[TEACHING_QUIZ_START]',
    '{"version":1,"quizzes":[',
    '  {"id":"q-1","kind":"single_choice","stem":"Question...","options":[{"id":"A","text":"Option A"},{"id":"B","text":"Option B"},{"id":"C","text":"Option C"},{"id":"D","text":"Option D"}],"answerHint":"Hint"}',
    ']}',
    '[TEACHING_QUIZ_END]',
    '- One question at a time; id must be unique; kind: single_choice.',
    '- Exactly 4 options; never reveal the answer.',
    '- Test conceptual understanding, not memorized facts.',
    '',
    '# Feedback Rules',
    '- Correct: Brief confirmation (e.g., "Yes, that is exactly the point."), then immediately next concept.',
    '- Wrong: Correct and briefly explain the core misconception (e.g., "Not quite — the key here is X, not Y, because..."), then immediately next concept.',
    '- No lengthy explanations, no re-testing, no bonus questions. Keep moving.',
  ].join('\n'),
  ...
  mcpWelcomeHint: 'Connect MCP tools — let your AI reach beyond the chat.',
  workspaceLoading: 'Loading...',
  workspaceSelectPrompt: 'Select working directory...',
  workspaceSelectFallback: 'Select workspace...',
  workspaceDesktopRequired: 'Agent mode requires desktop client',
  workspaceEmpty: 'No workspace directories',
  workspaceAdd: 'Add workspace directory',
  workspaceSelectDialog: 'Select working directory',
  workspaceRemove: 'Remove this workspace',
...
{memories}`,
  ...
  maxToolIterationsReached:
    'Maximum tool call rounds reached ({count}). You can continue by sending another message.',
