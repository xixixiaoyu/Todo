...
{memories}`,
  ...
  novelBookshelf: '故事书架',
  novelBookshelfEmpty: '还没有作品，创建你的第一个故事吧',
  novelCreateDraft: '新建作品',
  novelDraftTitle: '作品标题',
  novelDraftTitlePlaceholder: '给你的故事起个名字',
  novelChapterCount: '{count} 章',
  novelContinueWriting: '继续创作',
  novelBackToBookshelf: '返回书架',
  novelExportMarkdown: '导出 Markdown',
  novelExportTxt: '导出 TXT',
  novelExportJson: '导出 JSON',
  novelExportAllData: '导出所有数据',
  novelImportData: '导入数据',
  novelImportSuccess: '导入成功',
  novelImportError: '导入失败，请检查文件格式',
  novelDeleteConfirm: '确定删除作品「{title}」吗？此操作不可撤销。',
  novelSaveToBookshelf: '保存到书架',
  novelSavingToBookshelf: '正在保存...',
  novelActiveDraftIndicator: '当前作品：{title}',
