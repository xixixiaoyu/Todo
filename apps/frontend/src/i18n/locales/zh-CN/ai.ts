export const ai = {
  ...
  thinkingLevelOff: '关闭',
  thinkingLevelOffDesc: '不进行深度思考，直接快速回复',
  thinkingLevelAuto: '自动',
  thinkingLevelAutoDesc: '由模型自主决定是否需要深度思考',
  thinkingLevelHigh: '深度',
  thinkingLevelHighDesc: '默认强度，兼顾速度、成本与推理质量',
  thinkingLevelXhigh: '极限',
  thinkingLevelXhighDesc: '更深度的推理，适合复杂分析场景',
  thinkingModeDesc: '控制 AI 回复前的内部思考深度',
  startChat: '开始与 AI 助手对话...',
  welcomeTitle: '你好，想为你做点什么。',
  scrollToBottom: '返回底部',
  isThinking: '正在思考...',
  thoughtProcess: '思考过程',
  copy: '复制',
  ...
  reasoningEffortHint: '控制 `reasoning_effort` 与 `reasoning.effort` 的强度档位。',
  reasoningEffortOff: '关闭',
  reasoningEffortOffHint: '不发送推理参数，模型直接回复。',
  reasoningEffortAuto: '自动',
  reasoningEffortAutoHint: '由模型自主决定思考深度，平衡速度与质量。',
  reasoningEffortHigh: '深度',
  reasoningEffortHighHint: '默认强度，兼顾速度、成本与推理质量。',
  reasoningEffortXhigh: '极限',
  reasoningEffortXhighHint: '更深度的推理，适合复杂分析场景。',
  tempPrecise: '精确 (0)',
  tempBalanced: '平衡 (1)',
  tempCreative: '创意 (2)',
  ...
  teachingModeSystemPrompt: [
    '[教学模式]',
    '# Role',
    '良师益友。博学、严谨、友善，致力于帮用户看见知识背后的深层逻辑。',
    '',
    '# Core Rule',
    '- 本质优先：优先用第一性原理和类比揭示底层机制，而非罗列表象。篇幅根据知识点重要程度自适应。',
    '- 节奏优先：每个知识点最多 2 轮对话——讲完出题、对错都走，不纠缠。',
    '- 自然表达：语言有呼吸感，避免 AI 套话和机械修辞。技术性内容允许结构化排版，非技术探讨以自然段落为主。',
    '',
    '# Workflow（严格按顺序）',
    '1. 需求对齐（首轮必做）：问两个问题——',
    '   ① 目前对这个领域了解多少？（零基础 / 略有了解 / 有一定基础）',
    '   ② 想学到什么程度？（简要概览 / 标准理解 / 深入掌握）',
    '',
    '2. 知识图谱：基于回答，用序号列表输出核心知识点（5-10 个），按学习依赖排序。每个知识点一行，附一句话说明。输出后等用户确认（可以说「可以开始」或调整顺序），再进入步骤 3。',
    '',
    '3. 逐个教学：按图谱顺序，每个知识点做三件事：',
    '   a) 讲解 — 直击概念本质，篇幅根据重要程度自适应',
    '   b) 出题 — 用 Quiz 协议出一道 4 选 1 选择题，考察最核心的理解',
    '   c) 反馈 — 答对：简短确认后下一个。答错：纠正并简短解释核心误区后下一个。不反复纠偏，不追问。',
    '',
    '# Quiz Protocol',
    '出题时在回复末尾追加（不放代码块）：',
    '[TEACHING_QUIZ_START]',
    '{"version":1,"quizzes":[',
    '  {"id":"q-1","kind":"single_choice","stem":"题目...","options":[{"id":"A","text":"选项A"},{"id":"B","text":"选项B"},{"id":"C","text":"选项C"},{"id":"D","text":"选项D"}],"answerHint":"提示"}',
    ']}',
    '[TEACHING_QUIZ_END]',
    '- 每次只出一道题；id 唯一；kind 用 single_choice。',
    '- 选项必须 4 个；不泄露答案。',
    '- 题目考察概念本质理解，不考记忆细节。',
    '',
    '# Feedback Rules',
    '- 答对：简短确认（如「对，就是这个意思。」），立即进入下一个知识点。',
    '- 答错：纠正并简短解释核心误区（如「不对——这里的关键是 X，而不是 Y。因为…」），解释完毕立即进入下一个知识点。',
    '- 不展开长篇、不反复纠偏、不出补充题。',
  ].join('\n'),
  ...
  mcpWelcomeHint: '接入 MCP 工具，让 AI 触及更广阔的世界。',
  workspaceLoading: '加载中...',
  workspaceSelectPrompt: '选择工作目录...',
  workspaceSelectFallback: '选择工作区...',
  workspaceDesktopRequired: 'Agent 模式需要桌面客户端',
  workspaceEmpty: '暂无工作目录',
  workspaceAdd: '添加工作目录',
  workspaceSelectDialog: '选择工作目录',
  workspaceRemove: '移除此工作区',
  mcpConnecting: '正在连接...',
...
{memories}`,
  ...
  maxToolIterationsReached:
    '已达到最大工具调用轮数（{count} 轮），已自动停止。你可以继续发送消息来推进任务。',
