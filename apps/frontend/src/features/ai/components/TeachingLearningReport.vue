...
<template>
  <div class="mt-3 space-y-2">
    <div
      class="flex items-center gap-2 rounded-xl border border-[hsl(var(--ai-message-border)/0.8)] bg-[hsl(var(--ai-message-bg)/0.6)] px-3 py-2.5 backdrop-blur-sm"
    >
    ...
    <div
      ...
      class="rounded-xl border border-[hsl(var(--ai-message-border)/0.6)] bg-background/40 px-3 py-2.5"
    >
