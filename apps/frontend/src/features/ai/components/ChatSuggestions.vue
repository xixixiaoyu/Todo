...
<template>
  <div class="grid w-full max-w-3xl gap-3 sm:grid-cols-2 lg:grid-cols-3">
    <button
      v-for="item in suggestions"
      :key="item.title"
      class="group relative flex flex-col items-start rounded-xl border border-[hsl(var(--ai-glass-border))] bg-[hsl(var(--ai-glass-bg))] p-4 text-left transition-all hover:border-primary/40 hover:bg-primary/5 hover:shadow-md active:scale-[0.98]"
