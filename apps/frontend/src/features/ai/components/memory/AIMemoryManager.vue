...
import AIMemorySettingsPanel from '@/features/ai/components/memory/AIMemorySettingsPanel.vue'
import AIMemoryListPanel from '@/features/ai/components/memory/AIMemoryListPanel.vue'
