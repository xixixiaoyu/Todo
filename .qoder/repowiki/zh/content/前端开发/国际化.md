...
## 更新摘要
**所做更改**
- 新增 recommendedShort 键值支持中英文推荐标签（中文：优选，英文：Curated）
- 完善主题颜色的本地化支持，包括推荐标签的国际化显示
- 更新主题颜色选择器的推荐标签显示逻辑
- 增强主题颜色预设的本地化管理
...
**更新** 新增 recommendedShort 键值支持中英文推荐标签，完善主题颜色的本地化支持，包括推荐标签的国际化显示。
...
**更新** 新增主题颜色本地化的 recommendedShort 键值支持，完善推荐标签的国际化显示。
...
**更新** 新增 recommendedShort 键值支持中英文推荐标签显示，完善主题颜色的本地化支持。
...
**更新** 最新更新增强了主题颜色的本地化支持，通过新增 recommendedShort 键值实现了中英文推荐标签的国际化显示，进一步完善了主题系统的本地化体验。后续可在 RTL 支持、数字/货币本地化、覆盖率监控等方面持续增强。
...
- 新增语言
  ...
  - **新增**：确保新增语言包含 recommendedShort 键值
- 更新现有语言
